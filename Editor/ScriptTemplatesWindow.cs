...
namespace Ikaroon.ScriptTemplater
{
	public class ScriptTemplatesWindow : EditorWindow
	{
		...
		[MenuItem("Window/General/Script Templater")]
		static void Init()
		{
		...
		void CreateGUI()
		{
			...
			// Import UXML
			var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.ikaroon.scripttemplater/Editor/Data/UI/ScriptTemplatesWindow.uxml");
		...
		void AddExistingTemplate(SerializedProperty templateProperty)
		{
			...
			var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.ikaroon.scripttemplater/Editor/Data/UI/ScriptTemplateItem.uxml");
			VisualElement uxml = visualTree.Instantiate();
