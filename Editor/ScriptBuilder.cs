...
namespace Ikaroon.ScriptTemplater
{
	...
	public static class ScriptBuilder
	{
		...
		public static void GenerateScript([CallerFilePath] string filePath = "")
		{
			...
			var targetFile = Path.Combine(directory, "ScriptTemplaterMenuHook.cs");
		...
		static CodeCompileUnit GenerateClass()
		{
			...
			CodeNamespace nameSpace = new CodeNamespace("Ikaroon.ScriptTemplater");
			compileUnit.Namespaces.Add(nameSpace);

			nameSpace.Imports.Add(new CodeNamespaceImport("UnityEditor"));

			CodeTypeDeclaration mainClass = new CodeTypeDeclaration("ScriptTemplaterMenuHook");
